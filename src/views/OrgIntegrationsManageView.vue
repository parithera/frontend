...
const OrgManageIntegrationManage = defineAsyncComponent({
    loader: () => import('@/views/org/OrgManageIntegrationManage.vue'),
...
<template>
    <main>
        <OrgManageIntegrationManage :provider="props.provider" />
    </main>
</template>
