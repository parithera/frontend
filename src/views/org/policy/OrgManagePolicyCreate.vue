...
import FormSelectLicense from '@/common_components/forms/FormSelectLicense.vue';
...
const licenses: Ref<Set<String>> = ref(new Set<String>());
    ...
    try {
        await licensePolicyRepository.createPolicy({
            ...
            data: {
                ...
                licenses: Array.from(licenses.value),
